<template>
  <div class="m-auto mt-12 px-40 w-4/5">
    ...
    <section class="mt-12">
      ...
      <ol class="mt-2 divide-y divide-gray-200 text-sm/6 text-gray-500">
        <li class="py-4 sm:flex">
          <time datetime="2022-01-17" class="w-28 flex-none">Wed, Sept 18</time>
          <p class="mt-2 flex-auto sm:mt-0">Nothing on today’s schedule</p>
        </li>
        <li class="py-4 sm:flex">
          <time datetime="2022-01-19" class="w-28 flex-none">Thu, Oct 03</time>
          <p class="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">
            Standup VUE3/Vite Application
          </p>
        ...
        <li class="py-4 sm:flex">
          <time datetime="2022-01-20" class="w-28 flex-none">Fri, Oct 25</time>
          <p class="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">
            Meeting to Docker Containers
          </p>
          <p class="flex-none sm:ml-6">All day</p>
        </li>
        <li class="py-4 sm:flex">
          <time datetime="2022-01-18" class="w-28 flex-none">Mon, Oct 28</time>
          <p class="mt-2 flex-auto font-semibold text-gray-900 sm:mt-0">
            Work with Devops for Pipeline
          </p>
          <p class="flex-none sm:ml-6">
...
const months = [
  {
    ...
    days: [
      ...
      { date: "2024-10-29", isCurrentMonth: true, isToday: true },
